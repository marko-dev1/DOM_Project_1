...
//             padding: 15px 20px;
//             border-radius: 5px;
//             /* ensure above header, modals, etc */
//             z-index: 9999;
...
//         // Shuffle the products array first
...
//     return `
//       <div
//        class="product-card" data-name="${product.name.toLowerCase()}">
//           <div class="product-image-container" onclick="app.showProductDetail(${product.id})">
//               <img src="${imageUrl}"  loading ="lazy" width="300" height ="300"
//                    alt="${product.name}" 
//                    class="product-image"
//                    onerror="this.onerror=null; this.src='/uploads/default-product.jpg'">
...
//              <h3 class="product-name" style="margin-bottom:0;padding:0" title="${product.name}">${product.name ? product.name.substring(0, 45) + '...' : product.name} </h3>
...
//               ${product.stock > 0 ? `
// <a
//   href="https://wa.me/254703182530?text=${encodeURIComponent(
...
class ECommerceApp {
    ...
    addToCart(product, quantity = 1) {
        ...
        const cartProduct = {
            ...
            name: productObj.name,
            price: parseFloat(productObj.price),
            image_url: productObj.image_url || '/uploads/default-product.jpg',
            stock_quantity: productObj.stock_quantity,
            description: productObj.description
        };
